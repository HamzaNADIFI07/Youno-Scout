...
export const SIGNAL_DEFINITIONS: SignalDefinition[] = [
  ...
  {
    id: "linkedin-company",
    label: "Page LinkedIn entreprise",
    category: "maturity",
    weight: 8,
  },
  {
    id: "github-public",
    label: "Présence GitHub publique",
    category: "product",
    weight: 5,
  },
  {
    id: "twitter-x-presence",
    label: "Présence Twitter / X",
    category: "growth",
    weight: 3,
  },
  {
    id: "demo-cta",
    label: "CTA Demo / Book a meeting",
    category: "go-to-market",
    weight: 10,
  },
  {
    id: "free-trial-cta",
    label: "CTA Free trial / Get started",
    category: "go-to-market",
    weight: 8,
  },
  {
    id: "contact-sales-cta",
    label: "CTA Contact sales",
    category: "go-to-market",
    weight: 9,
  },
  {
