...
export const TECH_PATTERNS: TechPattern[] = [
  ...
  },
  {
    name: "Pipedrive",
    category: "marketing",
    patterns: [/pipedrive\.com/i, /pipedriveassets/i],
  },
  {
    name: "Attio",
    category: "marketing",
    patterns: [/attio\.com/i, /attioassets/i],
  },
  {
    name: "Koala",
    category: "marketing",
    patterns: [/getkoala\.com/i, /koala\.live/i, /kbox-/i],
  },
  {
    name: "Albacross",
    category: "marketing",
    patterns: [/albacross\.com/i, /alba-tracker/i],
  },
  {
    name: "Clearbit",
    category: "marketing",
    patterns: [/clearbit\.com/i, /clearbit-cdn/i, /clearbitscripts/i],
  },
  {
    name: "Typeform",
    category: "marketing",
    patterns: [/embed\.typeform\.com/i, /typeform\.com\/to/i],
  },
  {
    name: "Marketo",
    category: "marketing",
...
export const SIGNAL_DEFINITIONS: SignalDefinition[] = [
  ...
  {
    id: "crm-hubspot",
    label: "HubSpot installé",
    category: "product",
    weight: 9,
  },
  {
    id: "crm-salesforce",
    label: "Salesforce installé",
    category: "product",
    weight: 8,
  },
  {
    id: "tracking-ip-based",
    label: "Tracking IP / signal-based marketing",
    category: "product",
    weight: 10,
  },
  {
    id: "payment-stripe",
    label: "Stripe (modèle transactionnel)",
    category: "product",
    weight: 6,
  },
  {
    id: "support-chat",
    label: "Chat support en direct",
    category: "product",
    weight: 4,
  },
  {
    id: "model-plg",
    label: "Modèle PLG (essai gratuit)",
    category: "go-to-market",
    weight: 6,
  },
  {
    id: "model-enterprise",
    label: "Modèle Enterprise (demo only)",
    category: "go-to-market",
    weight: 9,
  },
  {
